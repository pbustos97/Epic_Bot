...
# Add Command
    elif message.content.startswith(botAddCmd) and msg[1] not in botDict and message.author.top_role.permissions.manage_roles:
...
# Remove Command
    elif message.content.startswith(botRmCmd) and message.author.top_role.permissions.manage_roles:
        if msg[1] in botDict:
            del botDict[msg[1]]
            np.save(serverId, botDict)
        else:
...
# Add Role
    elif message.content.startswith(botAddRole):
...
# Ban User
    elif message.content.startswith(botBanCmd):
...
# Kick User
    elif message.content.startswith(botKickCmd):
